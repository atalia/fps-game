...
class AudioManager {
  ...
  async loadSounds() {
    ...
    const soundDefs = {
      'shoot': { type: 'synth', freq: 150, duration: 0.1, attack: 0.01, decay: 0.09 },
      'reload': { type: 'synth', freq: 300, duration: 0.3, attack: 0.05, decay: 0.25 },
      'hit': { type: 'synth', freq: 200, duration: 0.15, attack: 0.01, decay: 0.14 },
      'kill': { type: 'synth', freq: 400, duration: 0.2, attack: 0.01, decay: 0.19 },
      'death': { type: 'synth', freq: 100, duration: 0.5, attack: 0.1, decay: 0.4 },
      'jump': { type: 'synth', freq: 250, duration: 0.1, attack: 0.01, decay: 0.09 },
      'land': { type: 'synth', freq: 80, duration: 0.1, attack: 0.01, decay: 0.09 },
      'footstep': { type: 'synth', freq: 60, duration: 0.05, attack: 0.01, decay: 0.04 },
      'empty': { type: 'synth', freq: 500, duration: 0.05, attack: 0.01, decay: 0.04 }
    }
